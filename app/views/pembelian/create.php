              ...
              <form role="form" action="<?= base_url; ?>/pembelian/simpanpembelian" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" min = "1" class="form-control" placeholder="masukkan jumlah barang yang hendak dibeli..." name="JumlahPembelian">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" max="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" pattern="\d{4}-\d{2}-\d{2}" placeholder="masukkan tanggal pembelian..." name="TanggalPembelian">
                  </div>
                  <div class="form-group">
